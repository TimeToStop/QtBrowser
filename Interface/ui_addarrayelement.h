/********************************************************************************
** Form generated from reading UI file 'addarrayelementLJCPuC.ui'
**
...
#ifndef ADDARRAYELEMENTLJCPUC_H
#define ADDARRAYELEMENTLJCPUC_H
...
public:
    ...
    void setupUi(QDialog *AddArrayElement)
    {
        ...
        AddArrayElement->resize(334, 124);
        ...
        gridLayout->addWidget(wait_for_redirect, 1, 2, 1, 1);
    ...
    void retranslateUi(QDialog *AddArrayElement)
    {
        ...
        label_3->setText(QCoreApplication::translate("AddArrayElement", "On Click:", nullptr));
